...
var cate_list_url = Baseurl+'category/index';
...
var pingjia_url=Baseurl + 'user.comment/submit';
...
var guanjianci_url=Baseurl+'index/tagslist';
var add_zuji_url=Baseurl+'goods/add_goods_review';

var lvka_list_url=Baseurl+'user.vip/index';
var lvka_quan_url=Baseurl+'coupon/viplists';
var pingjia_list_url=Baseurl+'comment/lists';
var buy_lvka_url=Baseurl+'user.vip/buy';
var lvka_goods_url=Baseurl+'user.vip/goodslist';
var changgou_url=Baseurl+'goods/nearbuylists';

var xinxi_url=Baseurl+'user.msg/index';
var chongzhi_url=Baseurl+'Recharge/submit';
var money_url=Baseurl+'Balance.Log/lists';
...
//活动页面
var miaosha_url=Baseurl+'index/flashpage';
var miaosha_list_url=Baseurl+'index/flashgoods';

//用户中心首页
var coupon_url = Baseurl + 'coupon/lists';
var lqkaquan_url = Baseurl + 'user.coupon/receive';
var user_center_url = Baseurl + 'user/detail';
var kaquan_url = Baseurl + 'user.coupon/lists';
...
var get_customerID_url = Baseurl +'payment/getId';
 ...
 function to_loading(){
   api.openWin({
       name: 'loading',
       url: 'widget://html/v1/loading/t1.html'
       });
 }
function to_denglu(){
  api.openWin({
...
function to_dizhi(){
  api.openWin({
      name: 'to_dizhi',
      url: 'widget://html/v2/member/address_list_win.html',
      pageParam: {
          id:0,
          title:"Gestion de Direcciones",
          muban:"address_list_frm"
      }
  });
}
...
function to_creditcardlist(){
  api.openWin({
      name: 'creditcardlist',
      url: 'widget://html/v2/common_win.html',
      pageParam: {
